...
B.HitCounterHUD = function(v,player,cam)
	...
	v.drawString(xo,yo,"Hits",V_HUDTRANS|V_SNAPTOTOP|V_SNAPTOLEFT|V_PERPLAYER,"right")
	v.drawString(xo,yo+8,tostring(B.HitCounter),V_HUDTRANS|V_SNAPTOTOP|V_SNAPTOLEFT|V_PERPLAYER,"right")
end
