...
B.GotFlagStats = function(player)
	...
	//Register debuff
	if (player.gotflag or player.gotcrystal or player.gotmaxrings) and player.gotflagdebuff == false then
	...
	if not(player.gotflag or player.gotcrystal or player.gotmaxrings) and player.gotflagdebuff == true then
